                    ...
                    <div class="md:flex md:justify-around">
                        ...
                        <div class="md:w-1/2 ml-4">
                            ...
                            <div class="flex justify-around items-center">
                                <div><span class="title-font font-medium text-2xl text-gray-900">{{ number_format($product->price) }}</span>
                                ...
                                <button class="flex m-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded">カートに入れる</button>
                            </div>
                        </div>
                    </div>
                </div>
